...
var RadarChart = {
  defaultConfig: {
    ...
    h: 600,
    factor: 0.7, //size
    factorLegend: 1, //label positions in relation to polygon
    levels: 4,
    maxValue: 850, //Lets keep and eye on this one
    radians: 2 * Math.PI,
    ...
    function radar(selection) {
      selection.each(function(data) {
        ...
        levelLine
          ...
          .attr('x2', function(levelFactor, i){ console.log(levelFactor+"hi"); return getHorizontalPosition(i+1, levelFactor); })
          ...
          if(cfg.axisText) {
            axis.select('text')
              ...
              .attr('dy', function(d, i) {
                ...
                return ((p < 0.1) ? '6em' : ((p > 0.9) ? '-4em' : '2.5em'));
              })
              .attr('dx', function(d, i) {
                var p = getHorizontalPosition(i, 0.5);
                return ((p < 0.4) ? '-1.2em' : ((p > 0.6) ? '1em' : '0.5em'));
              })
